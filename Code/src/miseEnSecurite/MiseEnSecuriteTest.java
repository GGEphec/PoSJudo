/**Cette classe permet de faire des tests unitaires sur la fonction de somme de la mise en sécurité
	...
	void test() {
		//1er cas, tout est nul => total = 0
			...
			//Création du fonds de caisse
				atester1 = new MiseEnSecurite(1, "2021-05-27", "Tests", contenu1);
			//Test
				assertEquals(0 ,atester1.sommeMiseEnSecurite());
		...
		//2eme cas, des valeurs quelconques
			...
			//Création du fonds de caisse
				atester2 = new MiseEnSecurite(1, "2021-05-27", "Tests", contenu2);
			//Test
				assertEquals(5092.6 ,atester2.sommeMiseEnSecurite());
		...
		//3eme cas, des valeurs quelconques et valeurs égales à 0
				...
				//Création du fonds de caisse
					atester3 = new MiseEnSecurite(1, "2021-05-27", "Tests", contenu3);
				//Test
					assertEquals(4991.59 ,atester3.sommeMiseEnSecurite());
	}
}
